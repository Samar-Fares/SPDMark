...
import torch
from spdmark_t2v_pipeline import TextToVideoSDPipeline
import glob
import math
from torchvision import transforms
import numpy as np
from diffusers.models import AutoencoderKL
from spdmark_routing_decoder_txt import message_to_route_mask_video, inject_routing_blocks_into_video_vae_decoder
def parse_args():
...
def main():
    ...
    BIT_LEN_VAE = BITS_PER_DECISION * TOTAL_SLOTS
    ...
    all_results = []  
    with open(args.prompts_txt_file, "r", encoding="utf-8") as f:
    ...
    for seed in [42, 0, 1789, 2025]:
        for i in range(2):
            ...
            routing_mask_vae = message_to_route_mask_video(
                msg_bits, num_resnets=num_resnet_blocks, num_paths=4
            )
            T = routing_mask_vae.shape[1]
            FPS = 7 
            ...
            water_frames = pipe(
                ...
                name='water',
                routing_mask_vae=routing_mask_vae,
                generator=generator,
            ).frames[0]
